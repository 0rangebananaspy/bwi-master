...
<body onload="window.print()" style="font-family:'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma,  sans-serif;width:21cm;">
		<table width="100%" border="0" cellpadding="2" cellspacing="0">
			<thead>
				<tr>
				 	<td colspan="2"><img src="../img/logo1.png" alt="logo" width="160" height="90"></td>
				 	<td colspan="5">
				 		<h1 style="margin:0">UD PUTRA PUTRI JAYA ALUMINIUM</h1>
				 		<h4 style="margin:0;margin-top:4px;">Jl. Sultan Agung Umpak Songo No. 70 Muncar, Banyuwangi.</h4>
						 <h5 style="margin:0;margin-top:4px;">Telp. 082131512529 / 082331501239 / 0822348855</h5>
				 	</td>
				</tr>
