...
<body onload="window.print()" style="font-family:'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma,  sans-serif;width:21cm;">
		<table width="100%" border="0" cellpadding="2" cellspacing="0">
			<thead>
				<tr>
				 	<td colspan="2"><img src="../img/logo1.png" alt="logo" width="75" height="80"></td>
				 	<td colspan="5">
				 		<h1 style="margin:0">UD PUTRA PUTRI JAYA ALUMINIUM</h1>
				 		<h5 style="margin:0;margin-top:4px;">Jl. Sultan Agung Umpak Songo No. 70 Muncar, Banyuwangi.</h5>
