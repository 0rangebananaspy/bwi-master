			...
			<ul class="nav navbar-nav navbar-right" style="margin-right:50px;">
				<li class="dropdown" id="hov">
					...
					<ul class="dropdown-menu" aria-labelledby="akun">
						...
						<li>
							<a href="?logout" onclick="return confirm('Apakah Anda yakin akan keluar dari akun ?');document.location.href='../../';"><div class="glyphicon glyphicon-log-out"></div> Logout</a>
						</li>
					</ul>
				</li>
			</ul>
