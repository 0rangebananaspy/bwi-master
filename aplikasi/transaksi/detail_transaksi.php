	...
	<div class="row">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<form method="post">
					<a href="../transaksi/transaksi_print.php?no_transaksi=<?php echo @$no_transaksi; ?>" target="_blank" class="btn btn-block btn-danger"><h4><b>C&nbsp;E&nbsp;T&nbsp;A&nbsp;K&nbsp;&nbsp;&nbsp;S&nbsp;T&nbsp;R&nbsp;U&nbsp;K&nbsp;&nbsp;&nbsp;&nbsp;P&nbsp;E&nbsp;N&nbsp;J&nbsp;U&nbsp;A&nbsp;L&nbsp;A&nbsp;N</b></h4></a>
					<a href="../transaksi/transaksi_kaca.php?no_transaksi=<?php echo @$no_transaksi; ?>" target="_blank" class="btn btn-block btn-success"><h4><b>C&nbsp;E&nbsp;T&nbsp;A&nbsp;K&nbsp;&nbsp;&nbsp;S&nbsp;T&nbsp;R&nbsp;U&nbsp;K&nbsp;&nbsp;&nbsp;&nbsp;P&nbsp;E&nbsp;N&nbsp;J&nbsp;U&nbsp;A&nbsp;L&nbsp;A&nbsp;N&nbsp;&nbsp;&nbsp;&nbsp;K&nbsp;A&nbsp;C&nbsp;A</b></h4></a>
					<br/>
