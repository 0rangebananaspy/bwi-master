...
//edit pembelian
	...
	if (isset($_POST['ubah_detail'])) {
		if ($_POST['tbanyak'] > $r['stok'] ) {
			$aksi->pesan("Maaf stok ".$r['nama_barang']." tidak mencukupi ".$_POST['tbanyak']." barang pembelian. Stok yang tersedia hanya ".$r['stok']." barang lagi");
			$aksi->alamat($alamat);
		}else if($_POST['tbanyak'] == 0 || $_POST['tbanyak']==""){
			$aksi->pesan("jumlah beli harus di isi lebih dari 0");
			$aksi->alamat($alamat);
			...
			<div class="col-md-9">
				<div class="panel panel-primary" >
					<div class="panel-heading" style="height:40px;">
						<h4 class="panel-title pull-left">UD PUTRA PUTRI JAYA ALUMINIUM</h4>
