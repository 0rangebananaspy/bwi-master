...
<head>
        ...
        <title>Aplikasi Inventory : Toko PUTRA PUTRI JAYA</title>
		...
		<div class="col-md-6">
			<div class="panel panel-primary" style="margin-top:120px;">
				<div class="panel-heading" style="padding:20px;">
					...
					<div style="font-size:200%;"><strong>SIM Toko Putra Putri Jaya</strong></S></div>
					<div class="col-md-1"></div>
				...
				<div class="panel-footer" align="center">
						&copy; 2021 - Toko Putra Putri Jaya | Developed by <a href="http://netfreak.my.if">NETfreak.my.id</a>
				</div>
			</div>
		</div>
