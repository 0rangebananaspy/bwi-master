...
<body>
	<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.php"><span style="color:#eb4d4b"><b>A D M I N  </b>  Panel</span></a>
		</div>
		<!-- akhir dari navbar atas -->
		<div class="navbar-collapse collaspse">
			<ul class="nav navbar-nav">
				<li class="dropdown" id="hov">
					<a class="dropdown-toggle" data-toggle="dropdown" href="#" id="input"><div class="glyphicon glyphicon-pencil"></div>&nbsp;&nbsp;KELOLA&nbsp; <span class="caret"></span></a>
					<ul class="dropdown-menu" aria-labelledby="input">
						<li>
							<a href="?menu=daftarjenis"><i class="fa fa-tasks"></i>  Kelola Daftar Jenis Barang</a>
						</li>
						<li>
							<a href="?menu=daftarbarang"><i class="fa fa-inbox"></i>  Kelola Daftar Barang</a>
						</li>
						<li>
							<a href="?menu=daftarsupplier"><i class="fa fa-truck"></i>  Kelola Daftar Supplier</a>
						</li>
						<li>
							<a href="?menu=daftaruser"><i class="fa fa-user"></i>  Kelola Daftar User</a>
						</li>
                        <li><div class="divider"></div></li>
						<li>
							<a href="?menu=pembelianbarang"><i class="fa fa-dropbox"></i>  Kelola Pembelian Barang</a>
						</li>
						<li>
							<a href="?menu=keuangan"><i class="fa fa-money"></i>  Kelola Keuangan Tambahan</a>
						</li>
					</ul>
				</li>
			</ul>
			...
			<ul class="nav navbar-nav">
				<li class="dropdown" id="hov">
					...
					<ul class="dropdown-menu" aria-labeldby="laporan">
						<li>
							<a href="?menu=lapjenisbarang"><i class="fa fa-tasks"></i>  Daftar Jenis Barang</a>
						</li>
						<li>
							<a href="?menu=lapbarang"><i class="fa fa-inbox"></i>  Daftar Barang</a>
						</li>
						<li>
							<a href="?menu=lapsupplier"><i class="fa fa-truck"></i>  Daftar Supplier</a>
						</li>
						<li>
							<a href="?menu=lapuser"><i class="fa fa-user"></i>  Daftar User</a>
						</li>
						<li class="divider"></li>
						<li>
							<a href="?menu=lapbelibarang"><i class="fa fa-bookmark"></i>  Laporan Pembelian (Bulanan)</a>
						</li>
						<li>
							<a href="?menu=laptransaksiharian"><i class="fa fa-tag"></i>  Laporan Transaksi &nbsp;(Harian)</a>
						</li>
						<li>
							<a href="?menu=laptransaksibulanan"><i class="fa fa-tags"></i>  Laporan Transaksi &nbsp;(Bulanan)</a>
						</li>
						<li>
							<a href="?menu=lapkeuangan"><i class="fa fa-calendar"></i>  Laporan Keuangan (Bulanan)</a>
						</li>
					</ul>
				</li>
			</ul>
			...
			<ul class="nav navbar-nav navbar-right">
				<li>
					<h5><a style="text-decoration:none;color:orange;margin-right:30px;margin-top:10px;" class="nav navbar-nav navbar-right">
					<div class="glyphicon glyphicon-time"></div>  Sekarang hari: 
