...
<br><br><br><br><br>
	<div class="container">
		<div class="col-md-12">
			<div class="alert alert-dismissible alert-success">
			  ...
			  Berhasil login sebagai: <span style="color:#f6e58d"><strong><b><u><?php echo $_SESSION['nama']; ?></u></b></strong></span> | Selamat bekerja dan tetap semangat! <br/><br/>  
			  <a href="?logout" onclick="return confirm('Apakah Anda yakin akan keluar ?');"><span id="blue"><b>LOGOUT</b></span></a>
			</div>
	...
	<div class="container-fluid">
		<div class="col-md-12">
			<div class="text-center" style="font-size:35px;" id="blue">
				<img src="../img/logo1.png" width="70" height="65">
				Toko <b>PUTRA PUTRI JAYA</b>
			</div><br/>
			<div style="width:100%;height:5px;background-color:#128f76; margin-bottom:15px;border-radius:30px;">&nbsp;</div>
			<div class="row">
				        ...
				        <div class="panel-heading">
				            <div class="row">
				                ...
				                <div class="col-xs-9 text-right">
				                    <div style="font-size:30px;"><?php echo $transaksihari['thari']; ?></div>
				                    <div><b>Transaksi Hari Ini</b></div>
				                </div>
				            </div>
				        </div>
				    ...
				    <div class="panel panel-success">
				        <div class="panel-heading">
				            <div class="row">
				                ...
				                <div class="col-xs-9 text-right">
				                    <div style="font-size:30px;"><?php echo $barangjual['bjual']; ?></div>
				                    <div><b>Barang Keluar Hari Ini</b></div>
				                </div>
				            </div>
				        </div>
				        <a href="?menu=laptransaksiharian">
				        ...
				        <div class="panel-heading">
				            <div class="row">
				                ...
				                <div class="col-xs-9 text-right">
				                    ...
				                    <div><b>Barang Masuk Hari Ini</b></div>
				                </div>
				            </div>
				        </div>
				    ...
				    <div class="panel panel-danger">
				        <div class="panel-heading">
				            <div class="row">
				                ...
				                <div class="col-xs-9 text-right">
				                    <div style="font-size:30px;"><?php echo $stok['stk']; ?></div>
				                    <div><b>Stok Barang Menipis</b></div>
				                </div>
				            </div>
				        </div>
				        <a href="?menu=pembelianbarang">
				    ...
				    <div class="panel panel-warning">
				        <div class="panel-heading">
				             <div class="row">
				                ...
				                <div class="col-xs-9 text-right">
				                    <div style="font-size:30px;"><?php echo $jenis['jns']; ?></div>
				                    <div><b>Jumlah Jenis Barang</b></div>
				                </div>
				            </div>
				        </div>
				    ...
				    <div class="panel panel-primary">
				        <div class="panel-heading">
				            <div class="row">
				                ...
				                <div class="col-xs-9 text-right">
				                    <div style="font-size:30px;"><?php echo $barang['brg']; ?></div>
				                    <div><b>Jumlah Barang Tersedia</b></div>
				                </div>
				            </div>
				        </div>
				    ...
				    <div class="panel panel-success">
				        <div class="panel-heading">
				            <div class="row">
				                ...
				                <div class="col-xs-9 text-right">
				                    <div style="font-size:30px;"><?php echo $user['us']; ?></div>
				    ...
				    <div class="panel panel-info">
				        <div class="panel-heading">
				            <div class="row">
				                ...
				                <div class="col-xs-9 text-right">
				                    <div style="font-size:30px;"><?php echo $supplier['sup']; ?></div>
				                    <div><b>Jumlah Supplier Barang</b></div>
				                </div>
				            </div>
				        </div>
